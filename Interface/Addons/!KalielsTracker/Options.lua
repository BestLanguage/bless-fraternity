				...
				sec6 = {
					...
					args = {
						...
						expandTrackerAfterTrack = {
							name = "Expand after track item",
							desc = "Expands the tracker after track new quest or item of a different type.",
							type = "toggle",
							set = function()
			...
			args = {
				...
				sec1 = {
					...
					args = {
						...
						addonTomTomDesc = {
							name = "TomTom support ... "..cWarning.."In progress|r ... I'm looking for a way|r",
							type = "description",
							width = "double",
							order = 1.32,
						},
