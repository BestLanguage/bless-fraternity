...
MTSLDBUI_SKILL_DETAIL_FRAME = {
    ...
    Initialise = function (self, parent_frame)
        ...
        self.ui_frame:SetPoint("TOPLEFT", MTSLDBUI_SORT_FRAME.ui_frame, "TOPRIGHT", -5, 0)
        --  Black background
        ...
        self.labels.name.title = MTSLUI_TOOLS:CreateLabel(self.ui_frame, "Name:", text_label_left, text_label_top, "SMALL", "TOPLEFT")
        ...
        self.labels.min_skill.title = MTSLUI_TOOLS:CreateLabel(self.ui_frame, "Needs skill level:", text_label_left, text_label_top, "SMALL", "TOPLEFT")
        ...
        self.labels.requires_xp.title = MTSLUI_TOOLS:CreateLabel(self.ui_frame, "Needs XP level:", text_label_left, text_label_top, "SMALL", "TOPLEFT")
        ...
        self.labels.requires_rep.title = MTSLUI_TOOLS:CreateLabel(self.ui_frame, "Needs reputation:", text_label_left, text_label_top, "SMALL", "TOPLEFT")
        ...
        self.labels.special_action.title = MTSLUI_TOOLS:CreateLabel(self.ui_frame, "Special action:", text_label_left, text_label_top, "SMALL", "TOPLEFT")
        ...
        self.labels.price.title = MTSLUI_TOOLS:CreateLabel(self.ui_frame, "Price:", text_label_left, text_label_top, "SMALL", "TOPLEFT")
        ...
        self.labels.type.title = MTSLUI_TOOLS:CreateLabel(self.ui_frame, "Learned from:", text_label_left, text_label_top, "SMALL", "TOPLEFT")
        ...
        self.labels.sources.title = MTSLUI_TOOLS:CreateLabel(self.ui_frame, "Learned from:", text_label_left, text_label_top, "SMALL", "TOPLEFT")
        ...
        self.labels.alt_type.title = MTSLUI_TOOLS:CreateLabel(self.ui_frame, "Also learned from:", text_label_left, text_label_top, "SMALL", "TOPLEFT")
        ...
        text_label_top = text_label_top - text_gap
        -- Labels to show "Trained by: <trainers> or Sold by: <vendors> or Dropped by: <mobs> or Obtained from: <quest>"
        self.labels.alt_sources.title = MTSLUI_TOOLS:CreateLabel(self.ui_frame, "Learned from:", text_label_left, text_label_top, "SMALL", "TOPLEFT")
    ...
    ShowNoSkillSelected = function(self)
        ...
        self.labels.sources.title:SetText(MTSLUI_FONTS.COLORS.TEXT.TITLE .. "Learned from:")
        self.labels.sources.title:Hide()
        self.labels.sources.ui_frame:Hide()
        self.labels.alt_type.title:SetText(MTSLUI_FONTS.COLORS.TEXT.TITLE .. "Also Learned from:")
        self.labels.alt_type.title:Hide()
        self.labels.alt_type.value:SetText("-")
        self.labels.alt_type.value:Hide()
        self.labels.alt_sources.title:SetText(MTSLUI_FONTS.COLORS.TEXT.TITLE .. "Learned from:")
    ...
    ShowDetailsOfSkill = function(self, prof_name, skill)
        if skill ~= nil then
            ...
            self.labels.name.value:SetText(MTSLUI_FONTS.COLORS.TEXT.NORMAL .. skill["name"][MTSL_CURRENT_LANGUAGE])
            ...
            -- no sources (special action only)
                ...
                self.labels.type.value:SetText(MTSLUI_FONTS.COLORS.TEXT.NORMAL .. "Special Action")
                self.labels.sources.title:Hide()
                self.labels.sources.ui_frame:Hide()
            end
            self.ui_frame:Show()
    ...
    ShowDetailsOfSkillTypeQuest = function(self, quest_ids, is_alternative_source)
        ...
        if quest ~= nil then
            if is_alternative_source == 1 then
                self.labels.alt_type.value:SetText(MTSLUI_FONTS.COLORS.TEXT.NORMAL .. "Quest: " .. quest["name"][MTSL_CURRENT_LANGUAGE])
            else
                self.labels.type.value:SetText(MTSLUI_FONTS.COLORS.TEXT.NORMAL .. "Quest: " .. quest["name"][MTSL_CURRENT_LANGUAGE])
            end
    ...
    ShowDetailsOfSkillTypeObject = function (self, oject_id)
        ...
        self.labels.type.value:SetText(MTSLUI_FONTS.COLORS.TEXT.NORMAL .. object["name"][MTSL_CURRENT_LANGUAGE])
    ...
    ShowDetailsOfSkillTypeItem = function(self, item_id, prof_name)
        local item = MTSL_TOOLS:GetItemById(item_id, prof_name)
        if item  == nil then
            ...
            self.labels.type.value:SetText(MTSLUI_FONTS:GetTextColorByItemQuality(item.quality) .. item["name"][MTSL_CURRENT_LANGUAGE])
            ...
            if amount_sources <= 0 then
                ...
                if has_drops > 0 then
                    ...
                    -- alternative/secundary source
                        ...
                        self.labels.alt_type.value:SetText(MTSLUI_FONTS.COLORS.TEXT.NORMAL .."Mobs")
    ...
    ShowDetailsOfNpcs = function(self, npcs, is_alternative_source)
        ...
        if npcs_amount <= 0 then
            labels_sources.values[1]:SetText(MTSLUI_FONTS.COLORS.TEXT.NORMAL .. "Not available for your faction!")
            ...
            for i=1,amount_labels do
                if npcs[i] ~= nil then
                    local text = npcs[i]["name"][MTSL_CURRENT_LANGUAGE] .. " - " ..  MTSL_TOOLS:GetZoneNameById(npcs[i].zone_id)
                    -- add coords if known
    ...
    ShowDetailsOfItems = function(self, items, is_alternative_source)
        ...
        for i=1, amount_labels do
            if items[i] ~= nil then
                local location =  MTSL_TOOLS:GetZoneNameById(items[i].zone_id)
                local text = "[item] " .. items[i]["name"][MTSL_CURRENT_LANGUAGE]
                if location ~= "" then
                    text = text  .. " - " .. location
                end
                -- add coords if known
    ...
    ShowDetailsOfObjects = function(self, objects, is_alternative_source)
        ...
        for i=1, amount_labels do
            if objects[i] ~= nil then
                local text =  "[object] " .. objects[i]["name"][MTSL_CURRENT_LANGUAGE] .. " - " ..  MTSL_TOOLS:GetZoneNameById(objects[i].zone_id)
                -- add coords if known
