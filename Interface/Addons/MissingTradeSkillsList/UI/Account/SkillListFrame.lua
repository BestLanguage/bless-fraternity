...
MTSLACCUI_SKILL_LIST_FRAME = {
    ...
    MAX_ITEMS_SHOWN = 20, -- becomes 19 with zone filter
    ITEM_HEIGHT = 19,
    ...
    FRAME_WIDTH = 345,
    -- height of the frame
    FRAME_HEIGHT = 422, -- becomes 400 with zone filter
    ...
    ChangeProfession = function(self, trade_skill_name, missing_skills)
        ...
        if self.trade_skill_name ~= trade_skill_name then
            ...
            self.profession_skills = MTSL_TOOLS:GetAllKnownSkillsForProfession(trade_skill_name, missing_skills, self.current_sort_by_name)
